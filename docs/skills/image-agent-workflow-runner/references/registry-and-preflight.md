...
- `bold_second_level`: completed BOLD DeepPrep outputs for the same subject/series, MNI BOLD data, and a matching MNI/EPI mask or documented ma<REDACTED_API_KEY> path.
