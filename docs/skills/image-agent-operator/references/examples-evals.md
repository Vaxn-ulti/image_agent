...
- If provenance has `placeholder_outputs` or `extraction_status=placeholder_contract_pending_real_deepprep_parser`, say the backend has a UI response placeholder, not final extracted T1 features.
