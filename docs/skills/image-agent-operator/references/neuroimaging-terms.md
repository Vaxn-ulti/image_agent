...
The first release may construct a minimal BIDS-like tree sufficient for container validation and execution. It is not necessarily a full BIDS-validator-clean dataset unless the implementation adds full validation.
