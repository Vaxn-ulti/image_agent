...
- The production command path uses the backend lightweight runner, host FSL GPU `eddy_cuda`, and MRtrix toolbox commands from the locked `pennlinc/qsiprep:26.0.0` image.
