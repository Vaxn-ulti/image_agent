...
Define first-round MVP handling for fMRI/BOLD preprocessing. In this product, fMRI/BOLD preprocessing is performed by DeepPrep. ALFF/fALFF may be added later as downstream metric calculation after BOLD preprocessing.
...
Do not require a perfect full BIDS dataset for MVP validation unless the implementation adds full BIDS-validator support.
