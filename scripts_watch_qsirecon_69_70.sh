...
LOG="$LOG_DIR/watch_qsirecon_69_70_$(date +%Y%m%d_%H%M%S).log"
mkdir -p "$LOG_DIR"
cd "$ROOT" || exit 1
...
QSIPREP_SERIES[69]=24
QSIPREP_SERIES[70]=27
...
log "Series map: 69 to 24 (case1/proj13), 70 to 27 (case3/proj15)"
log "============================================"
