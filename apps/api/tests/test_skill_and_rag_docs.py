...
def test_product_readiness_gate_blocks_frontend_until_agent_contracts_are_verified():
    ...
    for phrase in (
        ...
        "stale-task evidence must pass a `max_age_hours` freshness limit",
        "fresh approval evidence now exists",
        "/tmp/image_agent_stale_tasks_83_84_dry_run_20260613T1640Z.json",
        "/tmp/image_agent_stale_tasks_83_84_dry_run_20260614T080202Z.json",
        "checked.generated_at_utc",
        "2026-06-14T08:02:02.843606+00:00",
        "2026-06-13T16:40:24.758668+00:00",
        "approval_json_missing_or_older_than_24h",
        "set -a; . /home/yyf/project/image_agent/.env; set +a",
        "approved apply has not been run",
        "codex-gate-verifiers-efca895b-20260613T165132",
