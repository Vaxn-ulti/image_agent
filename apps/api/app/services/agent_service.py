...
def _fast_launch_readiness(*, agent: dict, production_readiness: dict) -> dict:
    ...
    model_target = {
        ...
        if (
            ...
            and provider_profile == "external_model_gateway"
        ...
        "expected_provider_profile": "external_model_gateway",
    ...
    if model_target["status"] != "passed":
        blocking_reasons.append("Model gateway is not pinned to direct external_model_gateway GPT-5.5 Responses with model tool loop.")
