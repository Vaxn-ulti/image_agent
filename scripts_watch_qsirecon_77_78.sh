...
LOG="$LOG_DIR/watch_qsirecon_77_78_$(date +%Y%m%d_%H%M%S).log"
mkdir -p "$LOG_DIR"
cd "$ROOT" || exit 1
...
QSIPREP_SERIES[77]=24
QSIPREP_SERIES[78]=27
QSIPREP_TASKS=(77 78)
QSIRECON_TASKS=()
...
log "Series map: 77 to 24 (case1/proj13), 78 to 27 (case3/proj15)"
log "============================================"
